...
![mobaxterm-home](../images//huong-dan-cai-dat-mobaxterm/giao-dien.png)

### 🔸 Chọn phiên bản Home để tải xuống

![mobaxterm-download](../images//huong-dan-cai-dat-mobaxterm/giao-dien-2.png)
...
![mobaxterm-ssh](../images//huong-dan-cai-dat-mobaxterm/SSH.png)

### 🔸 Bước 3: Nhập địa chỉ IP của Ubuntu

Gõ IP của máy ảo hoặc thiết bị Ubuntu vào ô **Remote host**.

![mobaxterm-ip](../images//huong-dan-cai-dat-mobaxterm/typing-ip.png)
